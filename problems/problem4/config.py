...
FAST_STRATEGY: Final[str] = "problem4_fast"
STRATEGIES: Final[tuple[str, str, str]] = (ROBUST_STRATEGY, MPC_STRATEGY, FAST_STRATEGY)


@dataclass(frozen=True, slots=True)
class Problem4Settings:
    """一次问题 3 运行使用的全部算法参数。"""
...
TRAJECTORY_FIGURE_DIR = FIGURES_DIR / "problem4"
