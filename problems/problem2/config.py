...
SCREENING_FIGURES = (
    PROBLEM2_FIGURES_DIR / "problem2_screening_principle_1_minimum_distance.png",
    PROBLEM2_FIGURES_DIR / "problem2_screening_principle_2_reception_probability.png",
    PROBLEM2_FIGURES_DIR / "problem2_screening_principle_3_region_intersection.png",
    PROBLEM2_FIGURES_DIR / "problem2_screening_principle_4_geometry_quality.png",
)
M1_POSTERIOR_GRID_FIGURE = (
    PROBLEM2_FIGURES_DIR / "problem2_m1_posterior_grid_sampling.png"
)
INTERSECTION_ANGLE_CONSTRAINT_FIGURE = (
    PROBLEM2_FIGURES_DIR / "problem2_intersection_angle_constraints.png"
)
